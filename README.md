...
Run those commands in a shell, then start or restart Codex. Use `ticket-writing`, `ticket-to-pr`, and `proposal-package-authoring` in a Codex conversation; they are skills, not shell commands.
