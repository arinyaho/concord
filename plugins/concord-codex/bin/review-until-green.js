...
const positional = args.filter((arg, index) => arg !== '--broad' && arg !== '--gate' && arg !== '--no-dod' && !broadPhraseArgs.has(index));
...
runReviewUntilGreen({ ref, base, broad, noDod, resume: resumed, repoRoot: process.cwd(), cliPath: path.join(__dirname, 'review-cli.js') })
