...
const { crossPlatformOpts, crossPlatformArgs } = require('../engine/spawn-cross-platform');
...
const ref = (resumed ? positional[1] : positional[0]) || require('node:child_process').execFileSync('git', crossPlatformArgs(['branch', '--show-current']), crossPlatformOpts({ encoding: 'utf8' })).trim();
