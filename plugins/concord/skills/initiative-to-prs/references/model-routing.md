...
| Ticket implementation | implementation | Up to two gpt-5.6-terra (high) or Sonnet repository tracers for independent repositories; only the stage owner edits code |
| Independent review | independent review | Up to two fresh gpt-5.6-terra (high/xhigh) or Sonnet specialists for bounded security, test, or cross-context questions |
