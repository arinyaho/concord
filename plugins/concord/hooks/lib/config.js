...
module.exports = {
  ...
  REVIEW_CLAUDE_TIMEOUT_MS_DEFAULT: 600 * 1000, // per-gate `claude -p` timeout: a generous safety net for a real-diff review, NOT a tuned cap. Env REVIEW_CLAUDE_TIMEOUT_MS overrides. (Was 90s tuned to the toy e2e -- too short for real PRs, so runs aborted as harness-failure.)
